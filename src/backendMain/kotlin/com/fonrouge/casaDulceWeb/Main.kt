...
import com.fonrouge.casaDulceWeb.database.Tables.UserItmDb
import com.fonrouge.casaDulceWeb.database.UserItm
import com.fonrouge.casaDulceWeb.services.*
import com.fonrouge.casaDulceWeb.upload.uploadsRoute
...
//    install(CallLogging)
    install(Sessions) {
        cookie<User>("CasaDulce", storage = SessionStorageMemory()) {
            cookie.path = "/"
