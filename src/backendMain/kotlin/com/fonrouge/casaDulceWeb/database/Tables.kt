...
object Tables : ITables {
    ...
    val CustomerOrderHdrDb = object : CTableDb<CustomerOrderHdr, OId<CustomerOrderHdr>>(
    ...
    val CustomerOrderItmDb = object : CTableDb<CustomerOrderItm, OId<CustomerOrderItm>>(
    ...
    val DeliveryItmDb = object : CTableDb<DeliveryOrderItm, OId<DeliveryOrderItm>>(
...
suspend fun getNextNumId(cTableDb: CTableDb<CustomerOrderHdr, OId<CustomerOrderHdr>>): Int {
