...
import com.fonrouge.casaDulceWeb.database.Tables.ShopifyImageDb
import com.fonrouge.casaDulceWeb.database.Tables.ShopifyProductDb
import com.fonrouge.casaDulceWeb.database.Tables.ShopifyVariantDb
...
actual class ShopifyApiService : IShopifyApiService {
    ...
    companion object {
        ...
        private suspend inline fun <T : BaseDoc<*>, reified U : Any> syncShopifyComponent(
            urlSuffix: String,
            funcList: (U) -> List<T>,
        ...
        private suspend inline fun <T : BaseDoc<*>, reified U : Any> shopifyComponentBlock(
            urlSuffix: String,
            state: String?,
            funcList: (U) -> List<T>,
        ): ListContainer<T> {
