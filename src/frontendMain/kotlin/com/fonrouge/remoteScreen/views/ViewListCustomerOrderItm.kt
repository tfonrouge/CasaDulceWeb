...
private val columnList: List<ColumnDefinition<CustomerOrderItm>> = listOf(
    ColumnDefinition(
        title = "#",
...
open class ViewListCustomerOrderItm(
    ...
    override val columnDefinitionList: List<ColumnDefinition<CustomerOrderItm>> = columnList
...
open class ViewListCustomerOrderItmByCustomerOrder(
    override var urlParams: UrlParams?
) : ViewList<CustomerOrderItm, DataListService>(
    configView = ConfigViewListCustomerOrderItmByCustomerOrderHdr,
    serverManager = DataListServiceManager,
    function = DataListService::customerOrderItmByCustomerOrder,
) {

    override val columnDefinitionList: List<ColumnDefinition<CustomerOrderItm>> = columnList

    override fun Container.pageListBody() {
        fsTabulator(this@ViewListCustomerOrderItmByCustomerOrder)
    }
}
