...
class LoginWindow : Dialog<Credentials>(closeButton = false, escape = false, animation = false) {
    ...
    init {
        ...
        cancelButton = Button(I18n.tr("Cancel"), "fas fa-times"){
            onClick {
        ...
        */
        loginButton = Button(I18n.tr("Login"), "fas fa-check", ButtonStyle.PRIMARY){
            onClick {
                this@LoginWindow.processCredentials()
            }
        }
        userButton = Button(I18n.tr("Register user"), "fas fa-user"){
            onClick {
